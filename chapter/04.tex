...
Da für das $\vec{B}$-Feld unter diesen Bedingungen gilt, dass rot $\vec{B} = \mu_0 \ \vec{j}$, ist es nicht möglich ein $\psi$ zu finden, sodass grad $\psi = \vec{B}$. Stattdessen macht man sich die Quellenfreiheit eines Wirbelfelds zu nutze und führt ein Vektorpotential $\vec{A}(\vec{r})$ ein, sodass:
...
-\laplace\vec{A}=\vphantom{\Bigg|}\mu_0 \ \vec{j}
\end{empheq}
...
\begin{align*}
\alignedbox{\hphantom{a}\vec{A}(\vec{r})} {= \frac{\mu_0}{4\pi}\Int{}{\vphantom{a}}{V'} \ \frac{\vec{j}(\vec{r}')}{|\vec{r}-\vec{r}'|}\hphantom{a}} \qquad \text{mit div }\vec{A} = 0 \\
\ \\
...
\ \\
\overset{\vec{B}= \rot\vec{A}}{\Rightarrow} \qquad\qquad \alignedbox{\hphantom{a}\vec{B}(\vec{r})}{= \frac{\mu_0}{4\pi} \ \sum_n \ I_n \int\limits_{\mathcal{L}_n}^{\vphantom{A}} \frac{\mathrm{d}\vec{r}' \times (\vec{r}-\vec{r}')}{|\vec{r}-\vec{r}'|^3}\hphantom{a}}
\end{align*}
\ \\
...
\begin{empheq}[box=\highlightbox]{equation*}
\Phi = \frac{\mu_0}{4\pi}\ \sum_n \ I_n \ \Oint{\partial\mathcal{S}_m}{\vphantom{A}}{\vec{r}}\ \cdot \ \Oint{\partial\mathcal{S}_n}{}{\vec{r}'}\frac{1}{|\vec{r}-\vec{r}'|} \ =: \ \sum_n \ L_{mn} \ I_n
\end{empheq}
...
\begin{empheq}[box=\highlightbox]{equation*}
\vec{m} \ := \ I \ \cdot \ \vec{A}_F\vphantom{\Bigg|}
\end{empheq}
\begin{equation*}
...
\ \\
\Rightarrow \qquad\qquad \alignedbox{\phantom{a}\vec{A}(\vec{r})} {= \frac{\mu_0 I \vphantom{\big|}}{4\pi\vphantom{\big|}} \; \vec{A}_F\times\frac{\vec{r}}{r^3} = \frac{\mu_0}{4\pi} \cdot \frac{\vec{m}\times\vec{r}}{r^3}\hphantom{a}}
\end{align*}
\ \\
