...
\begin{empheq}[box=\highlightbox]{equation*}
\pdiff{w\vphantom{\big|}}{t\vphantom{\big|}} \ + \ \div \vec{S}_P \ = \ \nu \ = \ -\vec{j} \cdot \vec{E}
\end{empheq}
...
w \ &= \ \frac{1\vphantom{\big|}}{2} \left(\epsilon_0\vec{E}^2 \ + \ \frac{1}{\mu_0}\vec{B}^2\right)\\
\vec{S}_P \ &= \ \frac{1}{\mu_0\vphantom{\big|}} \ \vec{E}\times\vec{B} 
\end{empheq}
...
\begin{empheq}[box=\highlightbox]{equation*}
W_e \ = \ \frac{1}{2} \ \Int{\vphantom{a}}{\vphantom{a}}{V} \rho \cdot \varphi \ = \ \frac{1}{8\pi\epsilon_0} \ \int\d V\int\d V' \; \frac{\rho(\vec{r}) \ \rho(\vec{r}')}{|\vec{r}-\vec{r}'|}
\end{empheq}
\newpage
...
\begin{empheq}[box=\highlightbox]{equation*}
W_e = \frac{1\vphantom{\big|}}{2\vphantom{\big|}} \sum_{ik} \ \varphi_i \ C_{ik} \ \varphi_k \ = 
...
\begin{empheq}[box=\highlightbox]{equation*}
W_m = \frac{\mu_0}{8\pi} \ \int\limits^{\vphantom{a}}_{\vphantom{a}}\d V \int\d V' \ \frac{\vec{j}(\vec{r}) \ \vec{j}(\vec{r}')}{|\vec{r}-\vec{r}'|}
\end{empheq}
...
\begin{empheq}[box=\highlightbox]{equation*}
\langle w\rangle \ = \ \frac{\epsilon_0\vphantom{\big|}}{2\vphantom{\big|}} \ \vec{E}_0^2
\end{empheq}
...
\begin{empheq}[box=\highlightbox]{equation*}
\langle\vec{S}_P\rangle \ = \ c \cdot \vec{e}_k \cdot \langle w\rangle \ = \ c \cdot \vec{e}_k \ \frac{\epsilon_0\vphantom{\big|}}{2\vphantom{\big|}} \ \vec{E}_0^2
\end{empheq}
\ \\
...
\begin{empheq}[box=\highlightbox]{align*}
\text{Impulsdichte} \qquad & \vec{g} \ = \ \epsilon_0 \ (\vec{E}\times\vec{B})\vphantom{\big|}\\
