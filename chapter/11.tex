...
\begin{wrapfigure}[]{r}[0cm]{0cm}
	\raisebox{0pt}[\dimexpr\height-1\baselineskip\relax]{
		\colorbox{hgrey}{
			\begin{tikzpicture}
			\filldraw[opacity = .4, pattern = north east lines] (-2,0)--(2,0)--(0,3)--(-2,0);
			\draw[ultra thick] (-2.5,1)--(-1,1.5);	
			\draw[ultra thick,dblue] (-1,1.5)--(1.1,1.3)--(2.5,0.7);
			\draw[ultra thick,red] (-1,1.5)--(0.9,1.6)--(2.5,1.3);
			\end{tikzpicture}
		}
	}
...
\begin{wrapfigure}[10]{l}[0cm]{0cm}
	\raisebox{0pt}[\dimexpr\height-1\baselineskip\relax]{
		\colorbox{hgrey}{
			\begin{tikzpicture}
			\draw[->] (-2,0)--(2,0) node[below]{$\vec{r}$};
			\draw[->] (0,0)--(0,3) node[above]{$V(\vec{r})$};
			\draw (-1.5,2.5) parabola bend (0,0) (1.5,2.5) ;
			\end{tikzpicture}
		}
	}
...
n^2 \ = \ \frac{\mathcal{N}^{\vphantom{\big|}} \ e^2}{\epsilon_0 m \left(\omega_0^{,2} \ - \ \omega^2\right)} \qquad \qquad \text{mit} \qquad \omega_0^{,2} \ = \ \omega_0^2\ \left(1 \ - \ \frac{\mathcal{N} \ e^2}{3 \epsilon_0 m \omega_0^2}\right)
\end{empheq}\\
...
\begin{wrapfigure}[9]{r}[0cm]{0cm}
	\raisebox{0pt}[\dimexpr\height-1\baselineskip\relax]{
		\colorbox{hgrey}{
			\begin{tikzpicture}
			\draw[->] (-.1,0)--(6,0) node[below]{$\omega$};
			\draw[->] (0,-2)--node[left]{$0$}(0,2) node[left]{$n^2$};
			\draw (-.1,.5)--(.1,.5);
			\draw (3,-.1)node[below left]{$\omega_0$}--(3,.1);
			\draw[dotted] (0,0.5)node[left]{$1$}--(6,.5);
			\draw[dotted] (3,-2)--(3,2);
			\draw[red] plot[smooth, tension=.8] coordinates {(0,.6)(2,.9)(2.8,2)};		
			\draw[red] plot[smooth, tension=.8] coordinates {(6,.4)(4,0)(3.2,-2)};				
			\end{tikzpicture}
		}
	}
...
\begin{wrapfigure}[]{r}[0cm]{0cm}
	\raisebox{0pt}[\dimexpr\height-1\baselineskip\relax]{
		\colorbox{hgrey}{
			\begin{tikzpicture}
			%1
			\draw[->] (-.1,0)node[left]{$0$}--(6,0) node[below]{$\omega$};
			\draw[->] (0,-.5)--(0,2) node[left]{$\tilde{n}^2$};
			\draw (-.1,.5)--(.1,.5);
			\draw (3,-.1)node[below left]{$\Omega$}--(3,.1);
			\draw[dotted] (0,0.5)node[left]{$1$}--(6,.5);
			\draw[dotted] (3,-.5)--(3,2);
			\draw[red] plot[smooth, tension=.8] coordinates {(0,.6)(2,.9)(2.8,2)};		
			\draw[red] plot[smooth, tension=.8] coordinates {(6,.4)(4,0)(3.35,-.5)};	
			\draw[dblue] (3,1) node[right]{$\ \ \gamma>0$};
			\draw[dblue] plot[smooth, tension=.8] coordinates {(0,.6)(2,.9)(2.8,1.5)(3.15,-.2)(4,.2)(6,.4)} ;			
			\end{tikzpicture}
		} 
	}
...
\colorbox{hgrey}{
	\begin{tikzpicture}
		\draw [thick](0,0) -- (10,0);
		\draw [red] (-1,-.3) node {Ionen};
		\foreach \x in {1,2,3,4,5,6,7,8,9}{
			\draw [color=red] (\x,-.3) circle[radius=.2cm] node[red]{$+$};}
		\draw [blue] (-1,.3) node {Elektronen};
		\foreach \x in {1,2.3,3.3,4.2,5,5.8,6.7,7.7,9}{
			\draw [color=blue] (\x,.3) circle[radius=.2cm] node[blue]{\_};}	
		\draw (2,-1) node {$\rho>0$};
		\draw (5,-1) node {$\rho<0$};
		\draw (8,-1) node {$\rho>0$};
		\draw [thick,<-] (2.8,-1.5) -- (4.2,-1.5);
		\draw [thick,->] (5.8,-1.5) -- (7.2,-1.5);
		\draw (3.5,-1.2) node {$\vec{F}$};
		\draw (6.5,-1.2) node {$\vec{F}$};
		\draw [color=hgrey] (0,.5) node{a};
		\draw [color=hgrey] (0,-1.5) node{a};
	\end{tikzpicture}}
\caption{Plasmon}
\end{figure}
...
\begin{wrapfigure}[12]{r}[0cm]{0cm}
	\raisebox{-1cm}[\dimexpr\height-1\baselineskip\relax]{
		\colorbox{hgrey}{
			\begin{tikzpicture}
			...
			\draw[scale=1.8,domain=-1.5:1.5,smooth,variable=\t,red] plot ({\t},{cos(1.5*deg(\t))},{0});
			\draw[scale=1.8,domain=-1.5:1.5,smooth,variable=\t,red] plot ({\t},{-cos(1.5*deg(\t))},{0});
			\draw[scale=1.8,domain=-1.5:1.5,smooth,variable=\t,blue] plot ({\t},{cos(1.5*deg(\t))*(cos(12*deg(\t)))});

			\draw (-1.9,-.2)--(-1.9,.2);
			\draw (-2,-1) node{$-\frac{\pi}{\Delta k}$};
			\draw (1.9,-.2)--(1.9,.2);
			\draw (1.9,-1) node{$\frac{\pi}{\Delta k}$};
			\draw[|-|,dblue] (.9,2)--(1.9,2) node[right]{$\lambda \ll \frac{\pi}{\Delta k}$};			
			\end{tikzpicture}
		}
	}
	\caption{Wellenpaket}
